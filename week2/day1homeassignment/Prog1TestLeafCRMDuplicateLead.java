...
public class Prog1TestLeafCRMDuplicateLead {
	...
	public static void main(String[] args) {
		...
		//Display Page Title for Duplicate page
		System.out.println(driver.getTitle());
		
		driver.findElement(By.id("createLeadForm_companyName")).clear();
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys("New Test Company");
		driver.findElement(By.id("createLeadForm_firstName")).clear();
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("New Test First Name");
		driver.findElement(By.name("submitButton")).click();
